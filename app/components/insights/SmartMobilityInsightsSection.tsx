...
export default function SmartMobilityInsightsSection() {
  ...
  const demoInsights: InsightItem[] = useMemo(
    () => [
      {
        _id: 'demo-mobility-featured',
        slug: 'demo-smart-mobility-featured',
        title: 'Demo insight: City-level market entry for mobility platforms',
        metaDescription:
          'Sample content for layout while we wire the final Smart Mobility feed.',
        content:
          '<p>Demo insight content about evidence-led mobility market entry and corridor prioritisation.</p>',
        featuredImage: '/images/Dubai.jpg',
        insightCategorySlug: 'smart-mobility',
        createdAt: new Date().toISOString(),
      },
      {
        _id: 'demo-mobility-2',
        slug: 'demo-smart-mobility-2',
        title: 'Demo insight: Fleet electrification and charging economics',
        metaDescription: 'Sample insight card displayed until real CMS content is connected.',
        content: '<p>Demo insight content for EV transition and charging network planning.</p>',
        featuredImage: '/images/Dubai.jpg',
        insightCategorySlug: 'smart-mobility',
      ...
      {
        _id: 'demo-mobility-3',
        slug: 'demo-smart-mobility-3',
        title: 'Demo insight: Measuring impact of urban mobility programmes',
        metaDescription: 'Sample insight card displayed until real CMS content is connected.',
        content: '<p>Demo insight content for mobility monitoring, evaluation and learning.</p>',
        featuredImage: '/images/Dubai.jpg',
        insightCategorySlug: 'smart-mobility',
    ...
    const load = async () => {
      ...
      try {
        ...
        const findCategory =
          categoriesList.find(
            (c) =>
              normalized(c.name).includes('mobility') ||
              normalized(c.slug).includes('mobility') ||
              normalized(c.name).includes('transport'),
          ) || null;
  ...
  const categoryLabel = useMemo(() => {
    if (!categorySlug) return 'Smart Mobility';
    ...
    <section className="py-16 md:py-20 bg-white">
      <div className="container-custom">
        <div className="space-y-3 mb-10">
          ...
          <h2 className="text-4xl font-bold text-gray-900">Smart mobility research & analysis</h2>
