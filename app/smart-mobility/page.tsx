...
import SmartMobilityServicesSection from '../components/smart-mobility/SmartMobilityServicesSection';
import SmartMobilityPlatformSection from '../components/smart-mobility/SmartMobilityPlatformSection';
import { successStories } from '../data/success-stories';
import SmartMobilityInsightsSection from '../components/insights/SmartMobilityInsightsSection';

const whoWeWorkWith = [
  'Shared and on-demand mobility platforms',
  'Fleet and logistics operators',
  'Electric mobility and charging companies',
  'Autonomous mobility ventures',
  'Public transport authorities',
  'Telematics, fleet software, and mobility data providers',
...
export default function SmartMobilityPage() {
  const mobilityStories = successStories.filter((story) => story.sector === 'Smart Mobility');
        ...
        <section className="relative pt-32 md:pt-40 lg:pt-44 pb-18 md:pb-24 bg-[#046865] overflow-hidden">
          <div className="absolute inset-0">
            <Image
              ...
              alt="Smart mobility and urban transport"
              fill
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12 xl:gap-16 items-end">
              <div className="lg:col-span-7 space-y-6 md:space-y-7">
                ...
                <h1 className="text-4xl md:text-5xl lg:text-[3.5rem] font-bold text-white leading-[1.08] max-w-4xl">
                  Mobility intelligence for market entry, network design, and system transformation
                </h1>

                <p className="max-w-3xl text-base md:text-lg lg:text-xl text-white/82 leading-relaxed">
                  We help operators, cities, investors, and technology companies make sharper
                  decisions across demand, regulation, fleets, infrastructure, and digital products.
                </p>
              ...
              <div className="lg:col-span-5">
                <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-white/10 backdrop-blur-sm p-6 md:p-7 shadow-xl shadow-black/15">
                  ...
                  <h2 className="relative mt-4 text-2xl md:text-3xl font-bold text-[#FFE900] leading-tight">
                    From corridor evidence to scalable mobility
                  </h2>
                  <p className="relative mt-4 text-sm md:text-base text-white/82 leading-relaxed">
                    Our work spans market entry, competitive landscaping, electrification, operating
                    model insight, and technology-enabled research for complex urban and freight systems.
                  </p>

                  <div className="relative mt-6 grid grid-cols-2 gap-3">
                    <div className="rounded-xl border border-white/10 bg-white/8 p-4">
                      <p className="text-[10px] uppercase tracking-[0.14em] text-white/65">Coverage</p>
                      <p className="mt-2 text-base font-semibold text-white">Cities, fleets, platforms</p>
                    </div>
                    <div className="rounded-xl border border-white/10 bg-white/8 p-4">
          ...
          <div className="container-custom">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12 xl:gap-16 items-start">
              <div className="lg:col-span-4 space-y-6">
                ...
                <h2 className="heading-section">Partners across the mobility ecosystem</h2>
                <p className="text-base md:text-lg text-[#4B5563] leading-relaxed">
                  We work with organisations shaping how people and goods move—from shared platforms
                  and fleet operators to public authorities, investors, and industry associations.
                </p>
              </div>
              ...
              <div className="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
                <div className="lg:col-span-7">
                  ...
                  <h2 className="mt-4 text-3xl md:text-4xl font-bold text-white leading-tight">
                    Premium thinking, grounded in real mobility constraints
                  </h2>
                  <p className="mt-4 text-base md:text-lg text-white/82 leading-relaxed">
                    We bring together rigorous research, commercial realism, and systems thinking
                    so clients can move from uncertainty to decision with greater confidence.
                  </p>
                </div>
                ...
                <div className="lg:col-span-5">
                  <div className="relative w-full h-[280px] sm:h-[330px] md:h-[390px] rounded-2xl overflow-hidden border border-white/15 bg-white/10">
                    ...
                    <Image
                      src="/images/Dubai.jpg"
                      alt="Urban mobility corridors and transport infrastructure"
                      fill
              ...
              <div className="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
                <div className="lg:col-span-12 text-center space-y-5">
                  ...
                  <p className="text-base md:text-lg text-[#4B5563] leading-relaxed max-w-2xl mx-auto">
                    ...
                    it’s market entry, electrification, product validation, or impact evaluation.
                  </p>
